...
func NewUserService(userRepo user2.Repository, authService auth.Service) *UserService {
	return &UserService{
		userRepo:    userRepo,
...
func (s *UserService) Register(ctx context.Context, params RegisterUserParams) (*user2.User, error) {
...
func (s *UserService) GetByID(ctx context.Context, id uuid.UUID) (*user2.User, error) {
...
func (s *UserService) Update(ctx context.Context, id uuid.UUID, params UpdateUserParams) (*user2.User, error) {
...
func (s *UserService) List(ctx context.Context, offset, limit int) ([]*user2.User, error) {
	return s.userRepo.List(ctx, offset, limit)
}

func (s *UserService) Login(ctx context.Context, email, password string) (*user2.User, string, error) {
	if email == "" || password == "" {
